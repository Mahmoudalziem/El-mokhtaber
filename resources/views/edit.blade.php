    ...
    <div class="form-add">
        <div class="container position-relative">
            ...
            @if (session()->has('message'))
                <div class="alert alert-success mt-2 mx-auto message"
                    style="border-radius:0;text-align:center;font-size:30px" role="alert">
                    {{ session('message') }}
                </div>
            @endif
                ...
                <div class="row">
                        ...
                        <div class="content">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" value="{{ $data->age }}" name="age"
                                    id="patientAge" placeholder="سن المريض">
                                @error('age')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <input tyle="text" class="form-control date" value="{{ $data->auth }}" name="auth"
                                    id="auth" placeholder="تاريخ التصديق">
                                @error('auth')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <input tyle="text" class="form-control date" value="{{ $data->print }}" name="print"
                                    id="print" placeholder="تاريخ الطباعة">
                                @error('print')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="content">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control date" value="{{ $data->pay_date }}"
                                    name="pay_date" id="pay_date" placeholder="تاريخ الدفع">
                                @error('pay_date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <select name="branch" id="inputState" class="form-select">
                                    ...
                                    <option {{ $data->branch === 'Naga Hamady' ? 'selected="selected"' : '' }}
                                        value="Naga Hamady">نجح حمادي</option>
                                    <option {{ $data->branch === 'Mansoura 3 (Gehan)' ? 'selected="selected"' : '' }}
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" value="{{ $data->visit }}" name="visit"
                                    id="visit" placeholder="رقم الزيارة">
                                @error('visit')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
